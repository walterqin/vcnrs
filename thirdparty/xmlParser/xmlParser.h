 ...
 * </ul> */
typedef struct THIRDPARTY_EXPORT XMLDLLENTRY XMLNode
{
  private:
...
THIRDPARTY_EXPORT XMLDLLENTRY XMLSTR stringDup(XMLCSTR source, int cbData=-1);
/**< This is
...
THIRDPARTY_EXPORT XMLDLLENTRY void freeXMLString(XMLSTR t); // {free(t);}
/** @} */
 ...
 *
 * @{ */
THIRDPARTY_EXPORT XMLDLLENTRY char      xmltob(XMLCSTR xmlString,char defautValue=0);
THIRDPARTY_EXPORT XMLDLLENTRY int       xmltoi(XMLCSTR xmlString,int defautValue=0);
THIRDPARTY_EXPORT XMLDLLENTRY long long xmltol(XMLCSTR xmlString,long long defautValue=0);
THIRDPARTY_EXPORT XMLDLLENTRY double    xmltof(XMLCSTR xmlString,double defautValue=.0);
THIRDPARTY_EXPORT XMLDLLENTRY XMLCSTR   xmltoa(XMLCSTR xmlString,XMLCSTR defautValue=_CXML(""));
THIRDPARTY_EXPORT XMLDLLENTRY XMLCHAR   xmltoc(XMLCSTR xmlString,const XMLCHAR defautValue=_CXML('\0'));
/** @} */
...
typedef struct THIRDPARTY_EXPORT XMLDLLENTRY ToXMLStringTool
{
public:
...
typedef struct THIRDPARTY_EXPORT XMLDLLENTRY XMLParserBase64Tool
{
public:
